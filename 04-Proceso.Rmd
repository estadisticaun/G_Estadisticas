...
La *septima* característica de las estadísticas está relacionada con el fomento de la cultura estadística a nivel institucional. Para ello, se propone realizar de manera continua un conjunto de acciones, entre las que se sugieren:

1. *Realizar campañas de difusión a través de diversos medios de comunicación*.
2. *Socializar los resultados estadísticos en los cuerpos colegiados*.
3. *Construir material (físico y multimedia) para facilitar el acceso a la información estadística institucional*.
4. *Crear objetos tipo **Souvenir** para facilitar el acceso a la información estadística institucional*.
5. *Fomentar la capacitación y actualización de los funcionarios en matería de gestión estadística*.
6. *Participar en eventos de difusión estadística a nivel nacional e internacional*.
7. *Patrocinar congresos o eventos institucionales en materia de gestión estadística*.
8. *Promocionar la generación de valor de los datos disponibles a nivel institucional a través del fomento a la innovación y la realización de estudios institucionales*.
